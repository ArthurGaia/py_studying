...
soma = [x+y for x, y in lista_soma]
print(soma)

###############################################
# Solução do professor

lista_soma_professor1 = [x + y for x, y in zip(lista_a,lista_b)]
print(lista_soma_professor1)

lista_soma_professor2 = []
for i in range(len(lista_b)):
    lista_soma_professor2.append(lista_a[i] + lista_b[i])
print(lista_soma_professor2)

lista_soma_professor3 = []
for i, _ in enumerate(lista_b):
    lista_soma_professor3.append(lista_a[i] + lista_b[i])
print(lista_soma_professor3)
